...
class OptimizeLFNreadCountAndLFNvariantReplicate(ToolWrapper):
    ...
    def specify_input_file(self):
        return[
            OptimizeLFNreadCountAndLFNvariantReplicate.__input_file_positive_variants,
        ]
    ...
    def specify_output_file(self):
        return [
            ...
            # OptimizeLFNreadCountAndLFNvariantReplicate.__output_file_optimize_lfn_variant_specific,
        ]
    ...
    def run(self, f7_lfn_delete_absolute_read_count=None):
        ...
        #
        # Input file path
        input_file_positive_variants = self.input_file(OptimizeLFNreadCountAndLFNvariantReplicate.__input_file_positive_variants)
        #
        # Input table models
