...
class VsearchSortReads2(ToolWrapper):
    __mapper_args__ = {
        "polymorphic_identity": "wopmetabarcoding.wrapper.VsearchSortReads2"
    }
    __input_table_file = "File"
    __input_table_fileinformation = "FileInformation"
    __input_table_marker = "Marker"
    __input_table_primerpair = "PrimerPair"
    __input_table_sample = "Sample"
    __input_table_tag = "Tag"
    #
    ...
    def specify_input_table(self):
        return [
            VsearchSortReads2.__input_table_file,
            VsearchSortReads2.__input_table_fileinformation,
            VsearchSortReads2.__input_table_marker,
            VsearchSortReads2.__input_table_primerpair,
            VsearchSortReads2.__input_table_sample,
            VsearchSortReads2.__input_table_tag,
        ]

    def specify_output_file(self):
        return [
            VsearchSortReads2.__output_file_csvsearch,
            VsearchSortReads2.__output_file_fastadb,
            VsearchSortReads2.__output_file_reversefastadb,
            VsearchSortReads2.__output_file_fowardtrimmed,
            VsearchSortReads2.__output_file_outputforward
        ]

    def specify_output_table(self):
        return [
            VsearchSortReads2.__output_table_readcount,
            VsearchSortReads2.__output_table_outputcsv,
            VsearchSortReads2.__output_table_reversetrimmed,
            VsearchSortReads2.__output_table_obifasta,
            VsearchSortReads2.__output_table_variant
        ]
    ...
    def run(self):
        ...
        # Output file
        csv_output = self.output_file(VsearchSortReads2.__output_file_csvsearch)
        fasta_db = self.output_file(VsearchSortReads2.__output_file_fastadb)
        reverse_fasta_db = self.output_file(VsearchSortReads2.__output_file_reversefastadb)
        foward_trimmed = self.output_file(VsearchSortReads2.__output_file_fowardtrimmed)
        outputforward = self.output_file(VsearchSortReads2.__output_file_outputforward)

        # Table model
        file_information_model = self.input_table(VsearchSortReads2.__input_table_fileinformation)
        file_model = self.input_table(VsearchSortReads2.__input_table_file)
        readcount_model = self.output_table(VsearchSortReads2.__output_table_readcount)
        outputcsv_model = self.output_table(VsearchSortReads2.__output_table_outputcsv)
        reversetrimmed_model = self.output_table(VsearchSortReads2.__output_table_reversetrimmed)
        obifasta_model = self.output_table(VsearchSortReads2.__output_table_obifasta)
        variant_model = self.output_table(VsearchSortReads2.__output_table_variant)
