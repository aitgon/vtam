...
class KnownOccurrences(object):
    ...
    #         (self.read_tsv_into_df()).biosample_type == 'mock').values, ['run_id', 'marker_id', 'biosample_id']]
    ...
    #     run_marker_biosample_variant_keep_df = self.get_run_marker_biosample_variant_df(
    ...
    #         (self.read_tsv_into_df()).biosample_type == 'negative').values, ['run_id', 'marker_id', 'biosample_id']]
    ...
    #         (self.read_tsv_into_df()).action == 'delete').values]
