...
class OptimizeLFNreadCountAndLFNvariantRunner:
    ...
    def __init__(self, engine, known_occurrences, fasta_info_tsv_path, lfn_read_count_threshold):

        known_occurrences_df = KnownOccurrences.read_tsv_into_df(known_occurrences)
        ...
        for vknown_grouped_key in vknown_grouped.groups:
            ...
            known_occurrences = KnownOccurrences(known_occurrences_df=known_occurrences_i_df,
                                                 readinfo_tsv=fasta_info_tsv_path, engine=engine)
            ...
            for lfn_read_count_threshold_i in list(
                    range(lfn_read_count_threshold, lfn_read_count_threshold_test_max + 1, 10)):
                ...
                Logger.instance().debug(
                    "lfn_read_count_threshold: {} (Max {}); count_keep: {} (Max {})"
                        .format(lfn_read_count_threshold_i, lfn_read_count_threshold_test_max, count_keep,
                                count_keep_max))
            ...
            lfn_read_count_threshold_list = [
                *range(lfn_read_count_threshold, lfn_read_count_threshold_current_max + 1, int(
                ...
                for lfn_variant_or_variant_replicate_threshold_i in lfn_variant_or_variant_replicate_threshold_list:
                    ...
                    Logger.instance().debug(
                        ...
                        "count_keep_max: {}; count_keep: {}".format(
                            lfn_read_count_threshold_i, lfn_read_count_threshold_current_max,
            ...
            column_names = ['occurrence_nb_keep', 'occurrence_nb_delete', 'lfn_read_count_threshold',
            ...
            marker_id_to_name_df = pandas.DataFrame.from_records(data=marker_id_to_name,
                                                                 columns=['marker_id', 'marker_name'])
            lfn_variant_or_variant_replicate_specific_threshold_df = lfn_variant_or_variant_replicate_specific_threshold_df.merge(
    ...
    def lfn_read_count_and_lfn_variant(self, variant_read_count_df, is_optimize_lfn_variant_replicate, variant_keep_df,
                                       lfn_biosample_replicate_threshold, lfn_read_count_threshold, min_replicate_number,
                                       lfn_variant_or_variant_replicate_threshold):
        ...
        if not is_optimize_lfn_variant_replicate:  # optimize lfn variant replicate
            ...
            lfn_filter_runner.mark_delete_lfn_per_Ni_or_Nik_or_Njk(lfn_denominator='N_i',
                                                                   threshold=lfn_variant_or_variant_replicate_threshold)
        else:  # optimize lfn variant replicate
            # lfn_filter_runner.f3_f5_lfn_delete_variant_replicate(lfn_variant_or_variant_replicate_threshold)
            lfn_filter_runner.mark_delete_lfn_per_Ni_or_Nik_or_Njk(lfn_denominator='N_ik',
                                                                   threshold=lfn_variant_or_variant_replicate_threshold)
